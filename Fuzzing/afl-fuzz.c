...
static u8 fuzz_one(char** argv) {
  ...
  //u8 note[1000];
  FILE *fp = NULL;
  fp = fopen("/home/gla/test/fktest112.txt","a");
...
#define FLIP_BIT(_ar, _b) do { \
  ...
  for (stage_cur = 0; stage_cur < stage_max; stage_cur++) {
    ...
    //note[stage_cur +1 ] = "A";
    // FILE *fp = NULL;
    // fp = fopen("/home/gla/test/fktest.txt","a+");
    // fclose(fp);
...
havoc_stage:
  ...
  new_hit_cnt = queued_paths + unique_crashes +1;
